	...
	private void inicializarPanelCentral() {
		...
		txtFiltro.addFocusListener(new java.awt.event.FocusAdapter() {
		    ...
		    public void focusGained(java.awt.event.FocusEvent e) {
		    	String temp = txtFiltro.getText();
		        if (temp.equals("Buscar por título o autor...") || temp.equals("Buscar por título...")) {
		            txtFiltro.setText("");
		    ...
		    public void focusLost(java.awt.event.FocusEvent e) {
		    	if (txtFiltro.getText().isEmpty()) {
		            txtFiltro.setText("Buscar por título o autor...");
		            txtFiltro.setForeground(Color.GRAY);
		        }
		    }
		});
...
//	            panelInfo.addMouseListener(hoverListener);
	...
	private void actualizarFiltro() {
		...
		if (!texto.equals("Buscar por título o autor...") || texto.equals("Buscar por título...")) {
			txtFiltro.setForeground(Color.GRAY);
		} else {
	        txtFiltro.setForeground(Color.BLACK);
		}
